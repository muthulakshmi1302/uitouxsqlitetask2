...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_STUDENT_TABLE = "CREATE TABLE " + Config.TABLE_STUDENT + "("
                ...
                + Config.COLUMN_STUDENT_MARK1 + " TEXT"
                + Config.COLUMN_STUDENT_MARK2 + "TEXT" //nullable
                + Config.COLUMN_STUDENT_MARK3 + "TEXT" //nullable
                + Config.COLUMN_STUDENT_RANK + "INTEGER NOT NULL UNIQUE, " //nullable
                + Config.COLUMN_STUDENT_RESULT + " TEXT " //nullable
                + ")";
        ...
        String CREATE_SUBJECT_TABLE = "CREATE TABLE " + Config.TABLE_SUBJECT + "("
                ...
                + "FOREIGN KEY (" + Config.COLUMN_REGISTRATION_NUMBER + ") REFERENCES " + Config.TABLE_STUDENT + "(" + Config.COLUMN_STUDENT_RANK + ") ON UPDATE CASCADE ON DELETE CASCADE, "
